...
(:action FROM-BOTTOM-TO-HOME
  ...
  :precondition
   (and (CHECKED) (FORCED)  (LASMOSSA ?card) (CLEAR ?card) (BOTTOMCOL ?card) (HOME ?card_to) (SUIT ?card ?suit) (SUIT ?card_to ?suit) 
    (VALUE ?card ?val) (VALUE ?card_to ?val_to) (SUCCESSOR ?val ?val_to ) (COLSPACE ?ncol_prev) (SUCCESSOR ?ncol ?ncol_prev))
  :effect
   (and  (not (CHECKED)) (not (FORCED)) (not (LASMOSSA ?card)) (not (HOME ?card_to)) (HOME ?card) (not (CLEAR ?card)) (not (BOTTOMCOL ?card)) 
...
(:action FROM-STACK-TO-HOME
  ...
  :precondition
   (and (CHECKED) (LASMOSSA ?card) (LASMOSSA ?card) (CLEAR ?card) (HOME ?card_to) (ON ?card ?card_prev) (SUIT ?card ?suit) (SUIT ?card_to ?suit) 
    (VALUE ?card ?val) (VALUE ?card_to ?val_to) (SUCCESSOR ?val ?val_to ))
  :effect
   (and  (not (CHECKED)) (not (FORCED)) (not (LASMOSSA ?card)) (not (HOME ?card_to)) (HOME ?card) (not (CLEAR ?card)) (CLEAR ?card_prev) (not (ON ?card ?card_prev)))
)

(:action FROM-FREE-TO-HOME
  :parameters (?card - card ?card_to - card ?suit - suit ?val - num ?val_to - num ?ncol - num ?ncol_prev - num)
  :precondition
   (and (CHECKED) (FORCED) (LASMOSSA ?card) (INCELL ?card) (HOME ?card_to) (SUIT ?card ?suit) (SUIT ?card_to ?suit) 
    (VALUE ?card ?val) (VALUE ?card_to ?val_to) (SUCCESSOR ?val ?val_to ) (CELLSPACE ?ncol_prev) (SUCCESSOR ?ncol ?ncol_prev))
  :effect
   (and (not (CHECKED)) (not (FORCED)) (not (HOME ?card_to)) (HOME ?card) (not (INCELL ?card)) 
   (not (CELLSPACE ?ncol_prev)) (CELLSPACE ?ncol))
)

(:action CHECKFORCED
  :parameters (?card - card  ?suit - suit ?val - num ?val_to - num ?ncol - num ?ncol_prev - num)
  :precondition
   (and (not (CHECKED)) (exists (?card_to - card) (and (or (CLEAR ?card) (INCELL ?card)) (HOME ?card_to) (SUIT ?card ?suit) (SUIT ?card_to ?suit) 
   (VALUE ?card ?val) (VALUE ?card_to ?val_to) (SUCCESSOR ?val ?val_to ))))
  :effect
   (and (CHECKED) (FORCED) (LASMOSSA ?card)))

(:action CHECK
  :parameters (?card - card ?suit - suit ?val - num ?val_to - num ?ncol - num ?ncol_prev - num)
  :precondition
   (and (not (CHECKED)) ( not (exists (?card_to - card) (and (CLEAR ?card) (HOME ?card_to) (SUIT ?card ?suit) (SUIT ?card_to ?suit) 
   (VALUE ?card ?val) (VALUE ?card_to ?val_to) (SUCCESSOR ?val ?val_to )))))
  :effect
   (and (CHECKED)))
